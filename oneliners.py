if __name__ == '__main__':
    ...
    output = [b - a for a, b in zip(v, v[1:])] # Put your line here (my solution: 23 chars)
    print(output)
    ...
    """
    v = eval(input())
    output = sorted(set(v))  # Put your line here (my solution: 14 chars).
    print(output)
    ...
    output = int(sum((a - b) ** 2 for a, b in zip(v, u)) ** 0.5) # Put your line here (my solution: 40 chars)
    print(output)
    ...
    """
    m = eval(input())
    output = list(map(list,zip(*m)))  # Put your line here (my solution: 24 chars. Hint: *m)
    print(output)
